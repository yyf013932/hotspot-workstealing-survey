...
protected:
    ...
    //gc data
    static jlong _initial_time;
    static jlong _par_time;
    static jlong _final_time;
    ...
    // Private accessors
    static CardTableExtension *const card_table() {
        assert(_card_table != NULL, "Sanity");
        return _card_table;
    }
...
public:
    ...
    static int consecutive_skipped_scavenges() { return _consecutive_skipped_scavenges; }
    ...
    template<class T>
    static inline bool should_scavenge(T *p);
    ...
    template<class T>
    static inline bool should_scavenge(T *p, MutableSpace *to_space);

    template<class T>
    static inline bool should_scavenge(T *p, bool check_to_space);
